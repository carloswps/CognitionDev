import { r as reactExports, b as reactDomExports, a9 as PropTypes, R as React, an as _inheritsLoose, d as ReactDOM, ao as _objectWithoutPropertiesLoose, _ as _extends, ap as addClass, aq as removeClass$1 } from "./vendor.MscUbBdQ.js";
...
raf$1.setTimeout = (handler, ms) => {
  ...
  timeouts$1.splice(findTimeout$1(time), 0, timeout2);
  pendingCount$1 += 1;
  start$1();
  return timeout2;
};
...
var $get$1 = /* @__PURE__ */ Symbol.for("FluidValue.get");
var $observers$1 = /* @__PURE__ */ Symbol.for("FluidValue.observers");
...
var createStringInterpolator2$1 = (config2) => {
  ...
  return (input) => {
    const missingUnit = !unitRegex$1.test(output[0]) && output.find((value) => unitRegex$1.test(value))?.replace(numberRegex$1, "");
    let i = 0;
...
var $node$1 = /* @__PURE__ */ Symbol.for("Animated:node");
...
var cacheKey$1 = /* @__PURE__ */ Symbol.for("AnimatedComponent");
...
function scheduleProps(callId, { key, props, defaultProps, state, actions }) {
  return new Promise((resolve, reject) => {
    ...
    function onPause() {
      ...
      timeout2.cancel();
      delay = timeout2.time - raf$1.now();
    }
    function onResume() {
      if (delay > 0 && !globals_exports$1.skipAnimation) {
        state.delayed = true;
        timeout2 = raf$1.setTimeout(onStart, delay);
