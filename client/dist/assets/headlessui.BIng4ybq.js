import { r as reactExports, R as React, b as reactDomExports, ag as withSelectorExports, p as process, ah as useFloating, o as offset, s as shift, f as flip, ai as inner, g as size, aj as useInnerOffset, ak as useInteractions, m as autoUpdate, a as React$1, al as $f7dceffc5ad7768b$export$4e328f61c538687f, am as $6179b936705e76d3$export$ae780daf29e6d456 } from "./vendor.MscUbBdQ.js";
...
function w$6({ disabled: e2 = false } = {}) {
  let t2 = reactExports.useRef(null), [n2, l2] = reactExports.useState(false), r2 = p$5(), o4 = o$7(() => {
...
function C$7({ ourProps: n2, theirProps: r2, slot: e2, defaultTag: a3, features: s2, visible: t2 = true, name: l2, mergeRefs: i2 }) {
  i2 = i2 != null ? i2 : $$2;
  let o4 = P$2(r2, n2);
  if (t2) return F$3(o4, e2, a3, l2, i2);
  let y2 = s2 != null ? s2 : 0;
  if (y2 & 2) {
...
`));
    ...
    let d2 = f2.props, p2 = d2 == null ? void 0 : d2.className, c2 = typeof p2 == "function" ? (...R2) => t$4(p2(...R2), o4.className) : t$4(p2, o4.className), T2 = c2 ? { className: c2 } : {}, g2 = P$2(f2.props, m$6(h$4(o4, ["ref"])));
    for (let R2 in u2) R2 in g2 && delete u2[R2];
    return reactExports.cloneElement(f2, Object.assign({}, g2, u2, y2, { ref: s2(H$4(f2), y2.ref) }, T2));
  }
  return reactExports.createElement(t2, Object.assign({}, h$4(o4, ["ref"]), t2 !== reactExports.Fragment && y2, t2 !== reactExports.Fragment && u2), f2);
}
function U$3() {
...
function l$5(t2, r2) {
  ...
  return L$4()({ ourProps: o4, theirProps: e2, slot: {}, defaultTag: a$d, name: "Hidden" });
}
let f$a = K(l$5);
...
function j$4({ data: t2, form: e2, disabled: r2, onReset: n2, overrides: F2 }) {
  let [i2, a3] = reactExports.useState(null), p2 = p$5();
  return reactExports.useEffect(() => {
    if (n2 && i2) return p2.addEventListener(i2, "reset", n2);
  }, [i2, e2, n2]), React.createElement(c$6, null, React.createElement(C$6, { setForm: a3, formId: e2 }), e$4(t2).map(([s2, v2]) => React.createElement(f$a, { features: s$7.Hidden, ...m$6({ key: s2, as: "input", type: "hidden", hidden: true, readOnly: true, form: e2, disabled: r2, name: s2, value: v2, ...F2 }) })));
}
function C$6({ setForm: t2, formId: e2 }) {
  ...
  }, [t2, e2]), e2 ? null : React.createElement(f$a, { features: s$7.Hidden, as: "input", type: "hidden", hidden: true, readOnly: true, ref: (r2) => {
    if (!r2) return;
...
function s$6(l2) {
  ...
  for (; e2 && !a$c(e2); ) E$4(e2) && (t2 = e2), e2 = e2.parentElement;
...
function r$2(l2) {
  ...
  for (; e2 !== null; ) {
    if (E$4(e2)) return false;
    e2 = e2.previousElementSibling;
  }
  return true;
}
let u$8 = /* @__PURE__ */ Symbol();
...
let a$b = reactExports.createContext(null);
a$b.displayName = "DescriptionContext";
function f$8() {
  let r2 = reactExports.useContext(a$b);
  if (r2 === null) {
...
function U$2() {
  var r2, e2;
  return (e2 = (r2 = reactExports.useContext(a$b)) == null ? void 0 : r2.value) != null ? e2 : void 0;
}
function w$5() {
  ...
  return [r2.length > 0 ? r2.join(" ") : void 0, reactExports.useMemo(() => function(t2) {
    ...
    return React.createElement(a$b.Provider, { value: l2 }, t2.children);
  }, [e2])];
}
let S$2 = "p";
function C$5(r2, e2) {
  let d2 = reactExports.useId(), t2 = a$e(), { id: i2 = `headlessui-description-${d2}`, ...l2 } = r2, n2 = f$8(), s2 = y$6(e2);
  ...
  return L$4()({ ourProps: D2, theirProps: l2, slot: p2, defaultTag: S$2, name: n2.name || "Description" });
}
let _$1 = K(C$5), H$3 = Object.assign(_$1, {});
...
function U$1(n2, l2) {
  var E3;
  let a3 = reactExports.useId(), e2 = C$4(), o4 = u$a(), y2 = a$e(), { id: t2 = `headlessui-label-${a3}`, htmlFor: p2 = o4 != null ? o4 : (E3 = e2.props) == null ? void 0 : E3.htmlFor, passive: b2 = false, ...i2 } = n2, u2 = y$6(l2);
  ...
  let d2 = o$7((s2) => {
    ...
    if (!(s2.target !== s2.currentTarget && L$3(s2.target)) && (m$5(g2) && s2.preventDefault(), e2.props && "onClick" in e2.props && typeof e2.props.onClick == "function" && e2.props.onClick(s2), m$5(g2))) {
      ...
      if (r2) {
        ...
        let h2 = r2.getAttribute("aria-disabled");
        if (h2 === "true" || h2 === "") return;
...
let j$3 = K(U$1), V = Object.assign(j$3, {});
...
var h$3 = (t2, e2, r2) => e2 in t2 ? p$3(t2, e2, { enumerable: true, configurable: true, writable: true, value: r2 }) : t2[e2] = r2;
var f$6 = (t2, e2, r2) => (h$3(t2, e2 + "", r2), r2), b$3 = (t2, e2, r2) => {
...
let E$3 = class E {
  constructor(e2) {
    c$5(this, i$3, {});
    c$5(this, a$9, new a$a(() => /* @__PURE__ */ new Set()));
  ...
  on(e2, r2) {
    return n$4(this, a$9).get(e2).add(r2), this.disposables.add(() => {
      n$4(this, a$9).get(e2).delete(r2);
    });
  }
  send(e2) {
...
var r$1 = (e2, c2, t2) => c2 in e2 ? a$8(e2, c2, { enumerable: true, configurable: true, writable: true, value: t2 }) : e2[c2] = t2;
var p$2 = (e2, c2, t2) => (r$1(e2, typeof c2 != "symbol" ? c2 + "" : c2, t2), t2);
...
let o$2 = class o2 extends E$3 {
  constructor() {
    super(...arguments);
    p$2(this, "actions", { push: (t2) => this.send({ type: 0, id: t2 }), pop: (t2) => this.send({ type: 1, id: t2 }) });
    p$2(this, "selectors", { isTop: (t2, s2) => t2.stack[t2.stack.length - 1] === s2, inStack: (t2, s2) => t2.stack.includes(s2) });
  }
  static new() {
    return new o2({ stack: [] });
  }
  reduce(t2, s2) {
    return u$b(s2.type, y$4, t2, s2);
  }
};
const x$2 = new a$a(() => o$2.new());
function S$1(e2, n2, r2 = j$2) {
  return withSelectorExports.useSyncExternalStoreWithSelector(o$7((i2) => e2.subscribe(s$5, i2)), o$7(() => e2.state), o$7(() => e2.state), o$7(n2), r2);
}
function s$5(e2) {
  return e2;
}
function I$3(o4, s2) {
  let t2 = reactExports.useId(), r2 = x$2.get(s2), [i2, c2] = S$1(r2, reactExports.useCallback((e2) => [r2.selectors.isTop(e2, t2), r2.selectors.inStack(e2, t2)], [r2, t2]));
  return n$6(() => {
...
function y$3(t2, { allowed: r2, disallowed: e2 } = {}) {
  ...
  n$6(() => {
    ...
    for (let n2 of s2) {
      ...
      for (; o4 && o4 !== l2.body; ) {
        for (let p2 of o4.children) s2.some((E3) => p2.contains(E3)) || a3.add(h$2(p2));
        o4 = o4.parentElement;
      }
    }
    return a3.dispose;
...
let f$4 = ["[contentEditable=true]", "[tabindex]", "a[href]", "area[href]", "button:not([disabled])", "iframe", "input:not([disabled])", "select:not([disabled])", "textarea:not([disabled])"].map((e2) => `${e2}:not([tabindex='-1'])`).join(","), F$2 = ["[data-autofocus]"].map((e2) => `${e2}:not([tabindex='-1'])`).join(",");
var T$2 = ((n2) => (n2[n2.First = 1] = "First", n2[n2.Previous = 2] = "Previous", n2[n2.Next = 4] = "Next", n2[n2.Last = 8] = "Last", n2[n2.WrapAround = 16] = "WrapAround", n2[n2.NoScroll = 32] = "NoScroll", n2[n2.AutoFocus = 64] = "AutoFocus", n2))(T$2 || {}), y$2 = ((o4) => (o4[o4.Error = 0] = "Error", o4[o4.Overflow = 1] = "Overflow", o4[o4.Success = 2] = "Success", o4[o4.Underflow = 3] = "Underflow", o4))(y$2 || {}), S = ((t2) => (t2[t2.Previous = -1] = "Previous", t2[t2.Next = 1] = "Next", t2))(S || {});
...
function j$1(e2, r2) {
  return g$2(b$2(), r2, { relativeTo: e2 });
}
function g$2(e2, r2, { sorted: t2 = true, relativeTo: l2 = null, skipElements: o4 = [] } = {}) {
  let c2 = Array.isArray(e2) ? e2.length > 0 ? e2[0].ownerDocument : document : e2.ownerDocument, u2 = Array.isArray(e2) ? t2 ? P$1(e2) : e2 : r2 & 64 ? O$2(e2) : b$2(e2);
...
function k$2(o4, f2, h2) {
  let m2 = s$8(h2), s2 = reactExports.useCallback(function(e2, c2) {
    ...
    return !A(r2, h$1.Loose) && r2.tabIndex !== -1 && e2.preventDefault(), m2.current(e2, r2);
  ...
  }, true), s$4(o4, "blur", (t2) => s2(t2, () => u$9(window.document.activeElement) ? window.document.activeElement : null), true);
}
function n$2(...e2) {
  return reactExports.useMemo(() => o$9(...e2), [...e2]);
}
var m$3 = ((e2) => (e2[e2.Ignore = 0] = "Ignore", e2[e2.Select = 1] = "Select", e2[e2.Close = 2] = "Close", e2))(m$3 || {});
const g$1 = { Ignore: { kind: 0 }, Select: (r2) => ({ kind: 1, target: r2 }), Close: { kind: 2 } }, E$2 = 200;
...
function w$3() {
  return t$2() ? { before({ doc: n2, d: l2, meta: f2 }) {
    function i2(a3) {
...
a$6.subscribe(() => {
  ...
  for (let t2 of e2.values()) {
    ...
    (c2 && !o4 || !c2 && o4) && a$6.dispatch(t2.count > 0 ? "SCROLL_PREVENT" : "SCROLL_ALLOW", t2), t2.count === 0 && a$6.dispatch("TEARDOWN", t2);
  }
});
function a$5(r2, e2, n2 = () => ({ containers: [] })) {
  let f2 = o$1(a$6), o4 = e2 ? f2.get(e2) : void 0, i2 = o4 ? o4.count > 0 : false;
  return n$6(() => {
...
var T$1, b$1;
typeof process != "undefined" && typeof globalThis != "undefined" && typeof Element != "undefined" && ((T$1 = process == null ? void 0 : define_process_env_default) == null ? void 0 : T$1["NODE_ENV"]) === "test" && typeof ((b$1 = Element == null ? void 0 : Element.prototype) == null ? void 0 : b$1.getAnimations) == "undefined" && (Element.prototype.getAnimations = function() {
...
function x$1(t2, n2, e2, i2) {
  let [r2, o4] = reactExports.useState(e2), { hasFlag: s2, addFlag: a3, removeFlag: l2 } = c$4(t2 && r2 ? 3 : 0), u2 = reactExports.useRef(false), f2 = reactExports.useRef(false), E3 = p$5();
  return n$6(() => {
    var d2;
    if (t2) {
      if (e2 && o4(true), !n2) {
...
function Ae$1({ children: e2, enabled: t2 = true }) {
  ...
  ce(f2);
  let i2 = t2 && n2 !== null && f2 !== null, { to: F2 = "bottom", gap: E3 = 0, offset: A2 = 0, padding: c2 = 0, inner: h2 } = ge(n2, f2), [a3, p2 = "center"] = F2.split(" ");
  n$6(() => {
    i2 && o4(0);
  }, [i2]);
  let { refs: b2, floatingStyles: S2, context: g2 } = useFloating({ open: i2, placement: a3 === "selection" ? p2 === "center" ? "bottom" : `bottom-${p2}` : p2 === "center" ? `${a3}` : `${a3}-${p2}`, strategy: "absolute", transform: false, middleware: [offset({ mainAxis: a3 === "selection" ? 0 : E3, crossAxis: A2 }), shift({ padding: c2 }), a3 !== "selection" && flip({ padding: c2 }), a3 === "selection" && h2 ? inner({ ...h2, padding: c2, overflowRef: u2, offset: l2, minItemsVisible: D$2, referenceOverflowThreshold: c2, onFallbackChange(P2) {
    var L2, N2;
    if (!P2) return;
  ...
  return reactExports.createElement($$1.Provider, { value: r2 }, reactExports.createElement(y$1.Provider, { value: { setFloating: Y2, setReference: b2.setReference, styles: S2, getReferenceProps: Q2, getFloatingProps: X2, slot: G2 } }, e2));
}
function ce(e2) {
  n$6(() => {
    if (!e2) return;
...
function ge(e2, t2) {
  var o4, u2, f2;
  let n2 = O$1((o4 = e2 == null ? void 0 : e2.gap) != null ? o4 : "var(--anchor-gap, 0)", t2), r2 = O$1((u2 = e2 == null ? void 0 : e2.offset) != null ? u2 : "var(--anchor-offset, 0)", t2), l2 = O$1((f2 = e2 == null ? void 0 : e2.padding) != null ? f2 : "var(--anchor-padding, 0)", t2);
  return { ...e2, gap: n2, offset: r2, padding: l2 };
}
function O$1(e2, t2, n2 = void 0) {
  let r2 = p$5(), l2 = o$7((s2, i2) => {
...
function s$2() {
  ...
  return "useSyncExternalStore" in React$1 ? ((o4) => o4.useSyncExternalStore)(React$1)(() => () => {
  }, () => false, () => !r2) : false;
}
function l$1() {
  let r2 = s$2(), [e2, n2] = reactExports.useState(s$9.isHandoffComplete);
...
function I$1(e2) {
  let l2 = a$4(), o4 = reactExports.useContext(H$1), [r2, u2] = reactExports.useState(() => {
    var i2;
...
let M$2 = reactExports.Fragment, D$1 = K(function(l2, o4) {
  let { ownerDocument: r2 = null, ...u2 } = l2, t2 = reactExports.useRef(null), a3 = y$6(T$3((s2) => {
    t2.current = s2;
  ...
  }), P2 = reactExports.useContext(g), O2 = l$1();
  n$6(() => {
  ...
  let b2 = L$4();
  return O2 ? !p2 || !n2 ? null : reactDomExports.createPortal(b2({ ourProps: { ref: a3 }, theirProps: u2, slot: {}, defaultTag: M$2, name: "Portal" }), n2) : null;
});
function J(e2, l2) {
  let o4 = y$6(l2), { enabled: r2 = true, ownerDocument: u2, ...t2 } = e2, a3 = L$4();
  return r2 ? React.createElement(D$1, { ...t2, ownerDocument: u2, ref: o4 }) : a3({ ourProps: { ref: o4 }, theirProps: t2, slot: {}, defaultTag: M$2, name: "Portal" });
}
let X$1 = reactExports.Fragment, H$1 = reactExports.createContext(null);
function k(e2, l2) {
  let { target: o4, ...r2 } = e2, t2 = { ref: y$6(l2) }, a3 = L$4();
  return React.createElement(H$1.Provider, { value: o4 }, a3({ ourProps: t2, theirProps: r2, defaultTag: X$1, name: "Popover.Group" }));
}
let g = reactExports.createContext(null);
function oe() {
  let e2 = reactExports.useContext(g), l2 = reactExports.useRef([]), o4 = o$7((t2) => (l2.current.push(t2), e2 && e2.register(t2), () => r2(t2))), r2 = o$7((t2) => {
...
let B = K(J), q = K(k), ne$1 = Object.assign(B, { Group: q });
...
function H({ defaultContainers: r2 = [], portals: n2, mainTreeNode: o4 } = {}) {
  let l2 = n$2(o4), u2 = o$7(() => {
    var i2, c2;
    let t2 = [];
    for (let e2 of r2) e2 !== null && (t$3(e2) ? t2.push(e2) : "current" in e2 && t$3(e2.current) && t2.push(e2.current));
    if (n2 != null && n2.current) for (let e2 of n2.current) t2.push(e2);
    for (let e2 of (i2 = l2 == null ? void 0 : l2.querySelectorAll("html > *, body > *")) != null ? i2 : []) e2 !== document.body && e2 !== document.head && t$3(e2) && e2.id !== "headlessui-portal-root" && (o4 && (e2.contains(o4) || e2.contains((c2 = o4 == null ? void 0 : o4.getRootNode()) == null ? void 0 : c2.host)) || t2.some((d2) => e2.contains(d2)) || t2.push(e2));
    return t2;
  });
...
function P({ children: r2, node: n2 }) {
  let [o4, l2] = reactExports.useState(null), u2 = y(n2 != null ? n2 : o4);
  return React.createElement(a$2.Provider, { value: u2 }, r2, u2 === null && React.createElement(f$a, { features: s$7.Hidden, ref: (t2) => {
    var i2, c2;
    if (t2) {
      for (let e2 of (c2 = (i2 = o$9(t2)) == null ? void 0 : i2.querySelectorAll("html > *, body > *")) != null ? c2 : []) if (e2 !== document.body && e2 !== document.head && t$3(e2) && e2 != null && e2.contains(t2)) {
        l2(e2);
        break;
      }
    }
...
function y(r2 = null) {
  var n2;
  return (n2 = reactExports.useContext(a$2)) != null ? n2 : r2;
}
function f() {
...
function x(s2) {
  ...
  for (let t2 of s2.current) t$3(t2.current) && e2.add(t2.current);
  return e2;
}
let $ = "div";
...
function D(s2, e2) {
  let t2 = reactExports.useRef(null), r2 = y$6(t2, e2), { initialFocus: o4, initialFocusFallback: a3, containers: n2, features: u2 = 15, ...f2 } = s2;
  l$1() || (u2 = 0);
  let l2 = n$2(t2);
  ...
  let g2 = u$1(), v2 = o$7((c2) => {
    ...
    let E3 = t2.current;
    ((V2) => V2())(() => {
      u$b(g2.current, { [a$1.Forwards]: () => {
        g$2(E3, T$2.First, { skipElements: [c2.relatedTarget, a3] });
      }, [a$1.Backwards]: () => {
        g$2(E3, T$2.Last, { skipElements: [c2.relatedTarget, a3] });
      } });
    });
  }), A2 = I$3(!!(u2 & 2), "focus-trap#tab-lock"), N2 = p$5(), b2 = reactExports.useRef(false), k2 = { ref: r2, onKeyDown(c2) {
    ...
    i$4(L2) && L2.dataset.headlessuiFocusGuard !== "true" && (I(E3, L2) || (b2.current ? g$2(t2.current, u$b(g2.current, { [a$1.Forwards]: () => T$2.Next, [a$1.Backwards]: () => T$2.Previous }) | T$2.WrapAround, { relativeTo: c2.target }) : i$4(c2.target) && I$2(c2.target)));
  } }, B2 = L$4();
  return React.createElement(React.Fragment, null, A2 && React.createElement(f$a, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: v2, features: s$7.Focusable }), B2({ ourProps: k2, theirProps: f2, defaultTag: $, name: "FocusTrap" }), A2 && React.createElement(f$a, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: v2, features: s$7.Focusable }));
}
let w$2 = K(D), Re = Object.assign(w$2, { features: G });
function ee(s2 = true) {
  let e2 = reactExports.useRef(n.slice());
  return m$1(([t2], [r2]) => {
    r2 === true && t2 === false && t$5(() => {
      e2.current.splice(0);
  ...
  return m$1(() => {
    ...
    f2 && t$5(() => {
      ...
      if (r2 != null && r2.current) I$2(r2.current);
        ...
        if (s2 & 16) {
          if (g$2(f2, T$2.First | T$2.AutoFocus) !== y$2.Error) return;
        } else if (g$2(f2, T$2.First) !== y$2.Error) return;
...
function He$1() {
  let e2 = reactExports.useContext(M$1);
  if (e2 === null) throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return e2;
}
...
function Te(e2, t2) {
  let n2 = s$8(e2), l2 = reactExports.useRef([]), S2 = f(), R2 = p$5(), d2 = o$7((o4, i2 = A$1.Hidden) => {
  ...
  }), C2 = reactExports.useRef([]), p2 = reactExports.useRef(Promise.resolve()), h2 = reactExports.useRef({ enter: [], leave: [] }), g2 = o$7((o4, i2, a3) => {
...
function Ae(e2, t2) {
  var ee2, te2;
  let { transition: n2 = true, beforeEnter: l2, afterEnter: S2, beforeLeave: R$1, afterLeave: d2, enter: y2, enterFrom: C2, enterTo: p2, entered: h2, leave: g2, leaveFrom: v2, leaveTo: o4, ...i$12 } = e2, [a3, s2] = reactExports.useState(null), r2 = reactExports.useRef(null), f2 = ue(e2), j2 = y$6(...f2 ? [r2, t2, s2] : t2 === null ? [] : [t2]), H2 = (ee2 = i$12.unmount) == null || ee2 ? A$1.Unmount : A$1.Hidden, { show: u2, appear: z2, initial: K2 } = De(), [m2, G2] = reactExports.useState(u2 ? "visible" : "hidden"), Q2 = He$1(), { register: A2, unregister: I2 } = Q2;
  n$6(() => A2(r2), [A2, r2]), n$6(() => {
  ...
  let ce2 = K2 && !z2, Y2 = z2 && u2 && K2, W = reactExports.useRef(false), L2 = Te(() => {
  ...
  let pe = /* @__PURE__ */ (() => !(!n2 || !f2 || !B2 || ce2))(), [, T2] = x$1(pe, a3, u2, { start: Z, end: $2 }), Ce = m$6({ ref: j2, className: ((te2 = t$4(i$12.className, Y2 && y2, Y2 && C2, T2.enter && y2, T2.enter && T2.closed && C2, T2.enter && !T2.closed && p2, T2.leave && g2, T2.leave && !T2.closed && v2, T2.leave && T2.closed && o4, !T2.transition && u2 && h2)) == null ? void 0 : te2.trim()) || void 0, ...R(T2) }), N2 = 0;
  m2 === "visible" && (N2 |= i.Open), m2 === "hidden" && (N2 |= i.Closed), u2 && m2 === "hidden" && (N2 |= i.Opening), !u2 && m2 === "visible" && (N2 |= i.Closing);
  let he = L$4();
  return React.createElement(M$1.Provider, { value: L2 }, React.createElement(c$3, { value: N2 }, he({ ourProps: Ce, theirProps: i$12, defaultTag: de, features: fe, visible: m2 === "visible", name: "Transition.Child" })));
}
function Ie(e2, t2) {
  let { show: n2, appear: l2 = false, unmount: S2 = true, ...R2 } = e2, d2 = reactExports.useRef(null), y2 = ue(e2), C2 = y$6(...y2 ? [d2, t2] : t2 === null ? [] : [t2]);
  l$1();
  let p2 = u$3();
  ...
  return React.createElement(M$1.Provider, { value: v2 }, React.createElement(w$1.Provider, { value: s2 }, H2({ ourProps: { ...r2, as: reactExports.Fragment, children: React.createElement(me, { ref: C2, ...r2, ...R2, beforeEnter: f2, beforeLeave: j2 }) }, theirProps: {}, defaultTag: reactExports.Fragment, features: fe, visible: h2 === "visible", name: "Transition" })));
}
function Le$1(e2, t2) {
...
let X = K(Ie), me = K(Ae), Fe = K(Le$1), ze$1 = Object.assign(X, { Child: Fe, Root: X });
...
let z = K(function(t2, o4) {
  let a3 = reactExports.useId(), { id: n2 = `headlessui-dialog-${a3}`, open: i$12, onClose: s2, initialFocus: d2, role: p2 = "dialog", autoFocus: T2 = true, __demoMode: u2 = false, unmount: y$12 = false, ...S2 } = t2, F2 = reactExports.useRef(false);
  p2 = (function() {
  ...
  let f2 = reactExports.useRef(null), I2 = y$6(f2, o4), b2 = n$2(f2), g2 = i$12 ? 0 : 1, [v2, Q2] = reactExports.useReducer(Ue, { titleId: null, descriptionId: null, panelRef: reactExports.createRef() }), m2 = o$7(() => s2(false)), B2 = o$7((r2) => Q2({ type: 0, id: r2 })), D2 = l$1() ? g2 === 0 : false, [Z, ee2] = oe(), te2 = { get current() {
    var r2;
    return (r2 = v2.panelRef.current) != null ? r2 : f2.current;
  } }, L2 = y(), { resolveContainers: M2 } = H({ mainTreeNode: L2, portals: Z, defaultContainers: [te2] }), U2 = c2 !== null ? (c2 & i.Closing) === i.Closing : false;
  y$3(u2 || U2 ? false : D2, { allowed: o$7(() => {
    var r2, W;
  ...
  let H$12 = S$1(P2, reactExports.useCallback((r2) => P2.selectors.isTop(r2, n2), [P2, n2]));
  k$2(H$12, M2, (r2) => {
    r2.preventDefault(), m2();
  }), a$3(H$12, b2 == null ? void 0 : b2.defaultView, (r2) => {
  ...
  }), f$3(u2 || U2 ? false : D2, b2, M2), p$1(D2, f2, m2);
  let [oe$1, ne2] = w$5(), re2 = reactExports.useMemo(() => [{ dialogState: g2, close: m2, setTitleId: B2, unmount: y$12 }, v2], [g2, v2, m2, B2, y$12]), N2 = reactExports.useMemo(() => ({ open: g2 === 0 }), [g2]), le = { ref: I2, id: n2, role: p2, tabIndex: -1, "aria-modal": u2 ? void 0 : g2 === 0 ? true : void 0, "aria-labelledby": v2.titleId, "aria-describedby": oe$1, unmount: y$12 }, ae = !f$1(), E3 = G.None;
  D2 && !u2 && (E3 |= G.RestoreFocus, E3 |= G.TabLock, T2 && (E3 |= G.AutoFocus), ae && (E3 |= G.InitialFocus));
  let ie = L$4();
  return React.createElement(s$3, null, React.createElement(l, { force: true }, React.createElement(ne$1, null, React.createElement(w.Provider, { value: re2 }, React.createElement(q, { target: f2 }, React.createElement(l, { force: false }, React.createElement(ne2, { slot: N2 }, React.createElement(ee2, null, React.createElement(Re, { initialFocus: d2, initialFocusFallback: f2, containers: M2, features: E3 }, React.createElement(C$3, { value: m2 }, ie({ ourProps: le, theirProps: S2, slot: N2, defaultTag: He, features: Ne, visible: g2 === 0, name: "Dialog" })))))))))));
}), He = "div", Ne = O$3.RenderStrategy | O$3.Static;
function We(e2, t2) {
...
let $e = "div";
function je(e2, t2) {
  let o4 = reactExports.useId(), { id: a3 = `headlessui-dialog-panel-${o4}`, transition: n2 = false, ...i2 } = e2, [{ dialogState: s2, unmount: d2 }, p2] = O("Dialog.Panel"), T2 = y$6(t2, p2.panelRef), u2 = reactExports.useMemo(() => ({ open: s2 === 0 }), [s2]), y2 = o$7((I2) => {
    I2.stopPropagation();
...
let Ye = "div";
function Je(e2, t2) {
  let { transition: o4 = false, ...a3 } = e2, [{ dialogState: n2, unmount: i2 }] = O("Dialog.Backdrop"), s2 = reactExports.useMemo(() => ({ open: n2 === 0 }), [n2]), d2 = { ref: t2, "aria-hidden": true }, p2 = o4 ? Fe : reactExports.Fragment, T2 = o4 ? { unmount: i2 } : {}, u2 = L$4();
  return React.createElement(p2, { ...T2 }, u2({ ourProps: d2, theirProps: a3, slot: s2, defaultTag: Ye, name: "Dialog.Backdrop" }));
}
let Ke = "h2";
function Xe(e2, t2) {
  let o4 = reactExports.useId(), { id: a3 = `headlessui-dialog-title-${o4}`, ...n2 } = e2, [{ dialogState: i2, setTitleId: s2 }] = O("Dialog.Title"), d2 = y$6(t2);
...
let Ve = K(We), qe = K(je);
K(Je);
let ze = K(Xe), Lt = Object.assign(Ve, { Panel: qe, Title: ze, Description: H$3 });
function s$1(n2, t2) {
...
var E2 = ((t2) => (t2[t2.Open = 0] = "Open", t2[t2.Closed = 1] = "Closed", t2))(E2 || {}), L = ((t2) => (t2[t2.Single = 0] = "Single", t2[t2.Multi = 1] = "Multi", t2))(L || {}), F = ((t2) => (t2[t2.Pointer = 0] = "Pointer", t2[t2.Other = 1] = "Other", t2))(F || {}), M = ((r2) => (r2[r2.OpenListbox = 0] = "OpenListbox", r2[r2.CloseListbox = 1] = "CloseListbox", r2[r2.GoToOption = 2] = "GoToOption", r2[r2.Search = 3] = "Search", r2[r2.ClearSearch = 4] = "ClearSearch", r2[r2.RegisterOptions = 5] = "RegisterOptions", r2[r2.UnregisterOptions = 6] = "UnregisterOptions", r2[r2.SetButtonElement = 7] = "SetButtonElement", r2[r2.SetOptionsElement = 8] = "SetOptionsElement", r2[r2.SortOptions = 9] = "SortOptions", r2))(M || {});
...
let gt = reactExports.Fragment;
function vt(g2, D2) {
  let x2 = reactExports.useId(), u$12 = a$e(), { value: l2, defaultValue: p2, form: R2, name: i$12, onChange: b2, by: o4, invalid: d2 = false, disabled: m2 = u$12 || false, horizontal: a3 = false, multiple: t2 = false, __demoMode: s2 = false, ...A$12 } = g2;
  const v2 = a3 ? "horizontal" : "vertical";
  let U2 = y$6(D2), w2 = l$6(p2), [c$12 = t2 ? [] : void 0, O2] = T$4(l2, b2, w2), y2 = u({ id: x2, __demoMode: s2 }), I2 = reactExports.useRef({ static: false, hold: false }), N2 = reactExports.useRef(/* @__PURE__ */ new Map()), _2 = u$7(o4), H2 = reactExports.useCallback((h2) => u$b(n2.mode, { [L.Multi]: () => c$12.some((W) => _2(W, h2)), [L.Single]: () => _2(c$12, h2) }), [c$12]), n2 = reactExports.useMemo(() => ({ value: c$12, disabled: m2, invalid: d2, mode: t2 ? L.Multi : L.Single, orientation: v2, onChange: O2, compare: _2, isSelected: H2, optionsPropsRef: I2, listRef: N2 }), [c$12, m2, d2, t2, v2, O2, _2, H2, I2, N2]);
  n$6(() => {
    y2.state.dataRef.current = n2;
  }, [n2]);
  let L$12 = S$1(y2, (h2) => h2.listboxState), G2 = x$2.get(null), K2 = S$1(G2, reactExports.useCallback((h2) => G2.selectors.isTop(h2, x2), [G2, x2])), [E$12, z2] = S$1(y2, (h2) => [h2.buttonElement, h2.optionsElement]);
  k$2(K2, [E$12, z2], (h2, W) => {
    y2.send({ type: M.CloseListbox }), A(W, h$1.Loose) || (h2.preventDefault(), E$12 == null || E$12.focus());
  });
  let r2 = reactExports.useMemo(() => ({ open: L$12 === E2.Open, disabled: m2, invalid: d2, value: c$12 }), [L$12, m2, d2, c$12]), [B2, ae] = Q({ inherit: true }), le = { ref: U2 }, ie = reactExports.useCallback(() => {
    if (w2 !== void 0) return O2 == null ? void 0 : O2(w2);
  }, [O2, w2]), Z = L$4();
  return React.createElement(ae, { value: B2, props: { htmlFor: E$12 == null ? void 0 : E$12.id }, slot: { open: L$12 === E2.Open, disabled: m2 } }, React.createElement(Ae$1, null, React.createElement(c.Provider, { value: y2 }, React.createElement(re.Provider, { value: n2 }, React.createElement(c$3, { value: u$b(L$12, { [E2.Open]: i.Open, [E2.Closed]: i.Closed }) }, i$12 != null && c$12 != null && React.createElement(j$4, { disabled: m2, data: { [i$12]: c$12 }, form: R2, onReset: ie }), Z({ ourProps: le, theirProps: A$12, slot: r2, defaultTag: gt, name: "Listbox" }))))));
}
let Et = "button";
function ht(g2, D2) {
  let x2 = reactExports.useId(), u2 = u$a(), l2 = Y("Listbox.Button"), p$12 = p("Listbox.Button"), { id: R2 = u2 || `headlessui-listbox-button-${x2}`, disabled: i2 = l2.disabled || false, autoFocus: b2 = false, ...o4 } = g2, d2 = y$6(D2, Fe$1(), p$12.actions.setButtonElement), m2 = be(), [a3, t2, s2] = S$1(p$12, (r2) => [r2.listboxState, r2.buttonElement, r2.optionsElement]), A2 = a3 === E2.Open;
  k$1(A2, { trigger: t2, action: reactExports.useCallback((r2) => {
    if (t2 != null && t2.contains(r2.target)) return g$1.Ignore;
    let B2 = r2.target.closest('[role="option"]:not([data-disabled])');
    return n$5(B2) ? g$1.Select(B2) : s2 != null && s2.contains(r2.target) ? g$1.Ignore : g$1.Close;
  }, [t2, s2]), close: p$12.actions.closeListbox, select: p$12.actions.selectActiveOption });
  let v2 = o$7((r2) => {
    switch (r2.key) {
      case o$4.Enter:
        p$4(r2.currentTarget);
        break;
      case o$4.Space:
      case o$4.ArrowDown:
        r2.preventDefault(), p$12.actions.openListbox({ focus: l2.value ? c$2.Nothing : c$2.First });
        break;
      case o$4.ArrowUp:
        r2.preventDefault(), p$12.actions.openListbox({ focus: l2.value ? c$2.Nothing : c$2.Last });
        break;
    }
  }), U2 = o$7((r2) => {
    switch (r2.key) {
    ...
    var B2;
    if (r2.button === 0) {
      if (s$6(r2.currentTarget)) return r2.preventDefault();
      p$12.state.listboxState === E2.Open ? (reactDomExports.flushSync(() => p$12.actions.closeListbox()), (B2 = p$12.state.buttonElement) == null || B2.focus({ preventScroll: true })) : (r2.preventDefault(), p$12.actions.openListbox({ focus: c$2.Nothing }));
    }
  }), c2 = o$7((r2) => r2.preventDefault()), O2 = N([R2]), y2 = U$2(), { isFocusVisible: I2, focusProps: N$1 } = $f7dceffc5ad7768b$export$4e328f61c538687f({ autoFocus: b2 }), { isHovered: _2, hoverProps: H2 } = $6179b936705e76d3$export$ae780daf29e6d456({ isDisabled: i2 }), { pressed: n2, pressProps: L2 } = w$6({ disabled: i2 }), G2 = reactExports.useMemo(() => ({ open: a3 === E2.Open, active: n2 || a3 === E2.Open, disabled: i2, invalid: l2.invalid, value: l2.value, hover: _2, focus: I2, autofocus: b2 }), [a3, l2.value, i2, _2, I2, n2, l2.invalid, b2]), K2 = S$1(p$12, (r2) => r2.listboxState === E2.Open), E$12 = _$2(m2(), { ref: d2, id: R2, type: e$1(g2, t2), "aria-haspopup": "listbox", "aria-controls": s2 == null ? void 0 : s2.id, "aria-expanded": K2, "aria-labelledby": O2, "aria-describedby": y2, disabled: i2 || void 0, autoFocus: b2, onKeyDown: v2, onKeyUp: U2, onKeyPress: c2, onPointerDown: w2 }, N$1, H2, L2);
  return L$4()({ ourProps: E$12, theirProps: o4, slot: G2, defaultTag: Et, name: "Listbox.Button" });
}
let Le = reactExports.createContext(false), Dt = "div", At = O$3.RenderStrategy | O$3.Static;
function St(g2, D2) {
  let x2 = reactExports.useId(), { id: u2 = `headlessui-listbox-options-${x2}`, anchor: l2, portal: p$22 = false, modal: R$1 = true, transition: i$12 = false, ...b2 } = g2, o4 = ye(l2), [d2, m2] = reactExports.useState(null);
  o4 && (p$22 = true);
  let a3 = Y("Listbox.Options"), t2 = p("Listbox.Options"), [s2, A2, v2, U2] = S$1(t2, (e2) => [e2.listboxState, e2.buttonElement, e2.optionsElement, e2.__demoMode]), w2 = n$2(A2), c2 = n$2(v2), O2 = u$3(), [y2, I2] = x$1(i$12, d2, O2 !== null ? (O2 & i.Open) === i.Open : s2 === E2.Open);
  p$1(y2, A2, t2.actions.closeListbox);
  let N2 = U2 ? false : R$1 && s2 === E2.Open;
  f$3(N2, c2);
  let _2 = U2 ? false : R$1 && s2 === E2.Open;
  y$3(_2, { allowed: reactExports.useCallback(() => [A2, v2], [A2, v2]) });
  let H2 = s2 !== E2.Open, L$12 = s$1(H2, A2) ? false : y2, G2 = y2 && s2 === E2.Closed, K2 = l$2(G2, a3.value), E$12 = o$7((e2) => a3.compare(K2, e2)), z2 = S$1(t2, (e2) => {
    var X2;
    if (o4 == null || !((X2 = o4 == null ? void 0 : o4.to) != null && X2.includes("selection"))) return null;
    let S2 = e2.options.findIndex((se) => E$12(se.dataRef.current.value));
    return S2 === -1 && (S2 = 0), S2;
  }), r2 = (() => {
    if (o4 == null) return;
  ...
  })(), [B2, ae] = Re$1(r2), le = Te$1(), ie = y$6(D2, o4 ? B2 : null, t2.actions.setOptionsElement, m2), Z = p$5();
  reactExports.useEffect(() => {
    var S2;
    let e2 = v2;
    e2 && s2 === E2.Open && e2 !== ((S2 = o$9(e2)) == null ? void 0 : S2.activeElement) && (e2 == null || e2.focus({ preventScroll: true }));
  }, [s2, v2]);
  let h2 = o$7((e2) => {
    var S2, X2;
  ...
  }), Pe = reactExports.useMemo(() => ({ open: s2 === E2.Open }), [s2]), ge2 = _$2(o4 ? le() : {}, { id: u2, ref: ie, "aria-activedescendant": S$1(t2, t2.selectors.activeDescendantId), "aria-multiselectable": a3.mode === L.Multi ? true : void 0, "aria-labelledby": W, "aria-orientation": a3.orientation, onKeyDown: h2, role: "listbox", tabIndex: s2 === E2.Open ? 0 : void 0, style: { ...b2.style, ...ae, "--button-width": d$2(A2, true).width }, ...R(I2) }), ve = L$4(), Ee = reactExports.useMemo(() => a3.mode === L.Multi ? a3 : { ...a3, isSelected: E$12 }, [a3, E$12]);
  return React.createElement(ne$1, { enabled: p$22 ? g2.static || y2 : false, ownerDocument: w2 }, React.createElement(re.Provider, { value: Ee }, ve({ ourProps: ge2, theirProps: b2, slot: Pe, defaultTag: Dt, features: At, visible: L$12, name: "Listbox.Options" })));
}
let Rt = "div";
function _t(g2, D2) {
  let x2 = reactExports.useId(), { id: u2 = `headlessui-listbox-option-${x2}`, disabled: l2 = false, value: p$12, ...R2 } = g2, i2 = reactExports.useContext(Le) === true, b2 = Y("Listbox.Option"), o4 = p("Listbox.Option"), d2 = S$1(o4, (n2) => o4.selectors.isActive(n2, u2)), m2 = b2.isSelected(p$12), a3 = reactExports.useRef(null), t2 = s(a3), s$12 = s$8({ disabled: l2, value: p$12, domRef: a3, get textValue() {
    return t2();
  } }), A2 = y$6(D2, a3, (n2) => {
    n2 ? b2.listRef.current.set(u2, n2) : b2.listRef.current.delete(u2);
  }), v2 = S$1(o4, (n2) => o4.selectors.shouldScrollIntoView(n2, u2));
  n$6(() => {
    ...
    if (!i2) return o4.actions.registerOption(u2, s$12), () => o4.actions.unregisterOption(u2);
  }, [s$12, u2, i2]);
  let U2 = o$7((n2) => {
    var L$12;
    if (l2) return n2.preventDefault();
    o4.actions.onChange(p$12), b2.mode === L.Single && (reactDomExports.flushSync(() => o4.actions.closeListbox()), (L$12 = o4.state.buttonElement) == null || L$12.focus({ preventScroll: true }));
  }), w2 = o$7(() => {
    if (l2) return o4.actions.goToOption({ focus: c$2.Nothing });
    o4.actions.goToOption({ focus: c$2.Specific, id: u2 });
  }), c2 = u$4(), O2 = o$7((n2) => {
    c2.update(n2), !l2 && (d2 || o4.actions.goToOption({ focus: c$2.Specific, id: u2 }, F.Pointer));
  }), y2 = o$7((n2) => {
    c2.wasMoved(n2) && (l2 || d2 || o4.actions.goToOption({ focus: c$2.Specific, id: u2 }, F.Pointer));
  }), I2 = o$7((n2) => {
...
function Ct(g2, D2) {
  let { options: x2, placeholder: u2, ...l2 } = g2, R2 = { ref: y$6(D2) }, i2 = Y("ListboxSelectedOption"), b2 = reactExports.useMemo(() => ({}), []), o4 = i2.value === void 0 || i2.value === null || i2.mode === L.Multi && Array.isArray(i2.value) && i2.value.length === 0, d2 = L$4();
...
let Mt = K(vt), wt = K(ht), It = V, Bt = K(St), kt = K(_t), Ut = K(Ct), wo = Object.assign(Mt, { Button: wt, Label: It, Options: Bt, Option: kt, SelectedOption: Ut });
export {
  Bt as B,
  Fe as F,
  H$3 as H,
