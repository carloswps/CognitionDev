import { r as reactExports, j as jsxRuntimeExports, R as React, a as React$1, _ as _extends, b as reactDomExports, d as ReactDOM, e as ReactRemoveScroll, h as hideOthers, u as useFloating, o as offset, s as shift, l as limitShift, f as flip, g as size, i as arrow, k as hide, m as autoUpdate } from "./vendor.MscUbBdQ.js";
...
function createSlot$6(ownerName) {
  const SlotClone2 = /* @__PURE__ */ createSlotClone$6(ownerName);
...
function createCollection$3(name) {
  ...
  const [createCollectionContext, createCollectionScope2] = createContextScope$7(PROVIDER_NAME);
...
var useLayoutEffect2$6 = globalThis?.document ? reactExports.useLayoutEffect : () => {
};
var useInsertionEffect$4 = React$1[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$6;
...
var useLayoutEffect2$5 = globalThis?.document ? reactExports.useLayoutEffect : () => {
};
var useInsertionEffect$3 = React$1[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$5;
...
function createSlot$5(ownerName) {
  const SlotClone2 = /* @__PURE__ */ createSlotClone$5(ownerName);
  const Slot2 = reactExports.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = reactExports.Children.toArray(children);
...
var Presence$2 = (props) => {
  ...
  const ref = useComposedRefs$4(presence.ref, getElementRef$a(child));
...
var useReactId$4 = React$1[" useId ".trim().toString()] || (() => void 0);
var count$5 = 0;
function useId$4(deterministicId) {
  const [id, setId] = reactExports.useState(useReactId$4());
  useLayoutEffect2$5(() => {
...
var [createCollapsibleContext, createCollapsibleScope] = createContextScope$6(COLLAPSIBLE_NAME);
...
var CollapsibleContent = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Presence$2, { present: forceMount || context.open, children: ({ present }) => /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleContentImpl, { ...contentProps, ref: forwardedRef, present }) });
  }
);
...
var useReactId$3 = React$1[" useId ".trim().toString()] || (() => void 0);
var count$4 = 0;
function useId$3(deterministicId) {
  const [id, setId] = reactExports.useState(useReactId$3());
  useLayoutEffect2$6(() => {
    setId((reactId) => reactId ?? String(count$4++));
  }, [deterministicId]);
  return id ? `radix-${id}` : "";
}
var DirectionContext$3 = reactExports.createContext(void 0);
function useDirection$3(localDir) {
  const globalDir = reactExports.useContext(DirectionContext$3);
  return localDir || globalDir || "ltr";
}
var ACCORDION_NAME = "Accordion";
var ACCORDION_KEYS = ["Home", "End", "ArrowDown", "ArrowUp", "ArrowLeft", "ArrowRight"];
var [Collection$4, useCollection$4, createCollectionScope$4] = createCollection$3(ACCORDION_NAME);
var [createAccordionContext] = createContextScope$7(ACCORDION_NAME, [
...
var BookmarkIcon = /* @__PURE__ */ reactExports.forwardRef(function(_ref, forwardedRef) {
...
var BookmarkFilledIcon = /* @__PURE__ */ reactExports.forwardRef(function(_ref, forwardedRef) {
...
function $e42e1063c40fb3ef$export$b9ecd428b558ff10$2(originalEventHandler, ourEventHandler, { checkForDefaultPrevented = true } = {}) {
  return function handleEvent(event) {
...
const $1746a345f3d73bb7$var$useReactId$1 = React$1["useId".toString()] || (() => void 0);
...
const $5cb92bef7577960e$var$DismissableLayerContext$1 = /* @__PURE__ */ reactExports.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
const $5cb92bef7577960e$export$177fb62ff3ec1f22$1 = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  var _node$ownerDocument;
  const { disableOutsidePointerEvents = false, onEscapeKeyDown, onPointerDownOutside, onFocusOutside, onInteractOutside, onDismiss, ...layerProps } = props;
  const context = reactExports.useContext($5cb92bef7577960e$var$DismissableLayerContext$1);
  ...
  return /* @__PURE__ */ reactExports.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034$1.div, _extends({}, layerProps, {
    ref: composedRefs,
    style: {
...
function $5cb92bef7577960e$var$handleAndDispatchCustomEvent$1(name, handler, detail, { discrete }) {
...
const $d3863c46a17e8a28$export$20e40289641fbbb6$1 = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  reactExports.useEffect(() => {
    if (trapped) {
      let handleFocusIn = function(event) {
        ...
        if (focusScope.paused || !container1) return;
        if (!container1.contains(event.relatedTarget)) $d3863c46a17e8a28$var$focus$1(lastFocusedElementRef.current, {
          select: true
        });
      };
  ...
  return /* @__PURE__ */ reactExports.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034$1.div, _extends({
    tabIndex: -1
  }, scopeProps, {
    ref: composedRefs,
...
const $f1701beae083dbae$export$602eac185826482c$1 = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  return container ? /* @__PURE__ */ ReactDOM.createPortal(/* @__PURE__ */ reactExports.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034$1.div, _extends({}, portalProps, {
    ref: forwardedRef
  })), container) : null;
});
...
const $5d3850c4d0b4e6c7$export$2e1e1122cf0cba88 = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ reactExports.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034$1.button, _extends({
    type: "button",
    ...
    onClick: $e42e1063c40fb3ef$export$b9ecd428b558ff10$2(props.onClick, context.onOpenToggle)
  }));
});
...
const $5d3850c4d0b4e6c7$export$bd1d06c79be19e17 = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  return context.modal ? /* @__PURE__ */ reactExports.createElement($921a889cee6df7e8$export$99c2b779aa4e8b8b$1, {
    present: forceMount || context.open
...
const $5d3850c4d0b4e6c7$var$DialogContentModal = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog);
  const contentRef = reactExports.useRef(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05$1(forwardedRef, context.contentRef, contentRef);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ reactExports.createElement($5d3850c4d0b4e6c7$var$DialogContentImpl, _extends({}, props, {
    ...
    onFocusOutside: $e42e1063c40fb3ef$export$b9ecd428b558ff10$2(
...
const $5d3850c4d0b4e6c7$var$DialogContentImpl = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  }, /* @__PURE__ */ reactExports.createElement($5cb92bef7577960e$export$177fb62ff3ec1f22$1, _extends({
    role: "dialog",
    id: context.contentId,
...
const $5d3850c4d0b4e6c7$export$16f7638e4a34b909 = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ reactExports.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034$1.h2, _extends({
    id: context.titleId
  }, titleProps, {
    ref: forwardedRef
  }));
...
const $5d3850c4d0b4e6c7$export$94e94c2ec2c954d5 = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ reactExports.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034$1.p, _extends({
...
const $5d3850c4d0b4e6c7$export$fba2fb7cd781b7ac = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ reactExports.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034$1.button, _extends({
    ...
    ref: forwardedRef,
    onClick: $e42e1063c40fb3ef$export$b9ecd428b558ff10$2(
      props.onClick,
...
const [$5d3850c4d0b4e6c7$export$69b62a49393917d6] = $c512c27ab02ef895$export$fd42f52fd3ae1109($5d3850c4d0b4e6c7$var$TITLE_WARNING_NAME, {
...
const [$905f4ae918aab1aa$var$createAlertDialogContext] = $c512c27ab02ef895$export$50c7b4e9d9f19c1$2($905f4ae918aab1aa$var$ROOT_NAME, [
...
const $905f4ae918aab1aa$export$94e6af45f0af4efd = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  const dialogScope = $905f4ae918aab1aa$var$useDialogScope(__scopeAlertDialog);
  const contentRef = reactExports.useRef(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05$2(forwardedRef, contentRef);
  ...
  }), /* @__PURE__ */ reactExports.createElement($5e63c961fc1ce211$export$d9f1ccf0bdb05d45$1, null, children), false)));
});
...
const $905f4ae918aab1aa$export$2f67a923571aaea0 = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
  ...
  const dialogScope = $905f4ae918aab1aa$var$useDialogScope(__scopeAlertDialog);
  const ref = $6ed0406888f73fc4$export$c7b2cbe3552a0d05$2(forwardedRef, cancelRef);
...
function createCollection$2(name) {
  const PROVIDER_NAME = name + "CollectionProvider";
  const [createCollectionContext, createCollectionScope2] = createContextScope$4(PROVIDER_NAME);
  const [CollectionProviderImpl, useCollectionContext] = createCollectionContext(
    PROVIDER_NAME,
    { collectionRef: { current: null }, itemMap: /* @__PURE__ */ new Map() }
  );
...
var DirectionContext$2 = reactExports.createContext(void 0);
function useDirection$2(localDir) {
  const globalDir = reactExports.useContext(DirectionContext$2);
  return localDir || globalDir || "ltr";
}
var NODES$6 = [
  "a",
  ...
  reactExports.useEffect(() => {
    if (container) {
      ...
      if (!hasFocusedCandidate) {
        ...
        if (!mountEvent.defaultPrevented) {
          focusFirst$3(removeLinks(getTabbableCandidates(container)), { select: true });
...
var useLayoutEffect2$4 = Boolean(globalThis?.document) ? reactExports.useLayoutEffect : () => {
};
var useReactId$2 = React$1["useId".toString()] || (() => void 0);
var count$2 = 0;
function useId$2(deterministicId) {
  const [id, setId] = reactExports.useState(useReactId$2());
  useLayoutEffect2$4(() => {
...
var PopperAnchor = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : /* @__PURE__ */ jsxRuntimeExports.jsx(Primitive$6.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var Presence$1 = (props) => {
  ...
  const child = typeof children === "function" ? children({ present: presence.isPresent }) : reactExports.Children.only(children);
  const ref = useComposedRefs$3(presence.ref, getElementRef$7(child));
  const forceMount = typeof children === "function";
  return forceMount || presence.isPresent ? reactExports.cloneElement(child, { ref }) : null;
};
...
var [Collection$3, useCollection$3, createCollectionScope$3] = createCollection$2(GROUP_NAME$3);
var [createRovingFocusGroupContext$1, createRovingFocusGroupScope$1] = createContextScope$4(
  GROUP_NAME$3,
  [createCollectionScope$3]
);
var [RovingFocusProvider$1, useRovingFocusContext$1] = createRovingFocusGroupContext$1(GROUP_NAME$3);
var RovingFocusGroup$1 = reactExports.forwardRef(
  (props, forwardedRef) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$3.Provider, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$3.Slot, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsxRuntimeExports.jsx(RovingFocusGroupImpl$1, { ...props, ref: forwardedRef }) }) });
  }
);
RovingFocusGroup$1.displayName = GROUP_NAME$3;
var RovingFocusGroupImpl$1 = reactExports.forwardRef((props, forwardedRef) => {
  const {
  ...
  const [currentTabStopId = null, setCurrentTabStopId] = useControllableState$3({
...
var RovingFocusGroupItem$1 = reactExports.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
var MENU_NAME = "Menu";
var [Collection$2, useCollection$2, createCollectionScope$2] = createCollection$2(MENU_NAME);
var [createMenuContext, createMenuScope] = createContextScope$4(MENU_NAME, [
...
var MenuPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PortalProvider, { scope: __scopeMenu, forceMount, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Presence$1, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$1, { asChild: true, container, children }) }) });
};
...
var MenuContent = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$2.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Presence$1, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$2.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? /* @__PURE__ */ jsxRuntimeExports.jsx(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
...
var MenuSubContent = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = reactExports.useRef(null);
    const composedRefs = useComposedRefs$3(forwardedRef, ref);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$2.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Presence$1, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$2.Slot, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      MenuContentImpl,
      {
...
var [createDropdownMenuContext] = createContextScope$5(
  DROPDOWN_MENU_NAME,
  [createMenuScope]
);
...
function createSlot$4(ownerName) {
  const SlotClone2 = /* @__PURE__ */ createSlotClone$4(ownerName);
  const Slot2 = reactExports.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = reactExports.Children.toArray(children);
...
var DEFAULT_MAX = 100;
var [createProgressContext] = createContextScope$3(PROGRESS_NAME);
...
function createSlot$3(ownerName) {
  const SlotClone2 = /* @__PURE__ */ createSlotClone$3(ownerName);
  const Slot2 = reactExports.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = reactExports.Children.toArray(children);
...
var useInsertionEffect$2 = React$1[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$2;
...
function createSlot$2(ownerName) {
  const SlotClone2 = /* @__PURE__ */ createSlotClone$2(ownerName);
  const Slot2 = reactExports.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = reactExports.Children.toArray(children);
...
var Slider = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const [values = [], setValues] = useControllableState$2({
      prop: value,
      defaultProp: defaultValue,
      onChange: (value2) => {
      ...
      SliderProvider,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$1.Provider, { scope: props.__scopeSlider, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$1.Slot, { scope: props.__scopeSlider, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          SliderOrientation,
          {
            ...
            ...sliderProps,
            ref: forwardedRef,
            onPointerDown: composeEventHandlers$2(sliderProps.onPointerDown, () => {
...
var SliderHorizontal = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs$2(forwardedRef, (node) => setSlider(node));
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Primitive$2.span,
      {
        ...
        onPointerDown: composeEventHandlers$2(props.onPointerDown, (event) => {
          const target = event.target;
        ...
        onPointerMove: composeEventHandlers$2(props.onPointerMove, (event) => {
          const target = event.target;
...
var SliderThumb = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs$2(forwardedRef, (node) => setThumb(node));
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Collection$1.ItemSlot, { scope: props.__scopeSlider, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Primitive$2.span,
            {
              ...
              onFocus: composeEventHandlers$2(props.onFocus, () => {
...
var useInsertionEffect$1 = React$1[" useInsertionEffect ".trim().toString()] || useLayoutEffect2$1;
...
function createSlot$1(ownerName) {
  const SlotClone2 = /* @__PURE__ */ createSlotClone$1(ownerName);
  const Slot2 = reactExports.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = reactExports.Children.toArray(children);
...
const [$69cb30bb0017df05$var$createTabsContext] = $c512c27ab02ef895$export$50c7b4e9d9f19c1($69cb30bb0017df05$var$TABS_NAME, [
...
const [$054eb8030ebde76e$var$createToastContext] = $c512c27ab02ef895$export$50c7b4e9d9f19c1("Toast", [
...
const $cb5cc270b50c6fcd$export$d6ac43ebaa40d53e = /* @__PURE__ */ reactExports.forwardRef((props, forwardedRef) => {
...
export {
  $905f4ae918aab1aa$export$c6fdb837b070b4ff as $,
  Range as A,
  Thumb$1 as B,
  ChevronDownIcon as C,
  Root$1 as D,
  Thumb as E,
  $69cb30bb0017df05$export$54c2e3dc7acea9f5 as F,
  $69cb30bb0017df05$export$41fb9f06171c75f4 as G,
  Header as H,
  Item$2 as I,
  $69cb30bb0017df05$export$7c6e2c02157bb7d2 as J,
  $905f4ae918aab1aa$export$602eac185826482c as K,
  $cef8881cdc69808e$export$be92b6f5f03c0fe9 as L,
  $cef8881cdc69808e$export$41fb9f06171c75f4 as M,
  $cef8881cdc69808e$export$602eac185826482c as N,
  $5d3850c4d0b4e6c7$export$41fb9f06171c75f4 as O,
  Root2$3 as P,
  Root2$1 as Q,
  Root$5 as R,
  Separator2 as S,
  ...
  CheckboxItem2 as Y,
  ItemIndicator2 as Z,
  $054eb8030ebde76e$export$be92b6f5f03c0fe9 as _,
  Content2$2 as a,
  $054eb8030ebde76e$export$393edc798c47379d as a0,
  $cb5cc270b50c6fcd$export$41fb9f06171c75f4 as a1,
  $cb5cc270b50c6fcd$export$f39c2d165cd861fe as a2,
  $cb5cc270b50c6fcd$export$be92b6f5f03c0fe9 as a3,
  $cb5cc270b50c6fcd$export$602eac185826482c as a4,
  $cb5cc270b50c6fcd$export$7c6e2c02157bb7d2 as a5,
  BookmarkFilledIcon as a6,
  BookmarkIcon as a7,
  $69cb30bb0017df05$export$be92b6f5f03c0fe9 as a8,
  Root2 as a9,
  Item2 as aa,
  Indicator as ab,
  ArrowUpIcon as ac,
  ArrowDownIcon as ad,
  $054eb8030ebde76e$export$2881499e37b75b9a as ae,
  $054eb8030ebde76e$export$d5c6c08dc2d3ca7 as af,
  CrossCircledIcon as ag,
  $905f4ae918aab1aa$export$7c6e2c02157bb7d2 as b,
  clamp as c,
  $905f4ae918aab1aa$export$f99233281efd08a0 as d,
  $905f4ae918aab1aa$export$393edc798c47379d as e,
  $905f4ae918aab1aa$export$e19cd5f9376f8cee as f,
  $905f4ae918aab1aa$export$848c9b7ead0df967 as g,
  $5e63c961fc1ce211$export$8c6ed5c666ac1360 as h,
  $e698a72e93240346$export$be92b6f5f03c0fe9 as i,
  $e698a72e93240346$export$adb584737d712b70 as j,
  CaretSortIcon as k,
  ChevronUpIcon as l,
  CheckIcon as m,
  $5d3850c4d0b4e6c7$export$c6fdb837b070b4ff as n,
  $5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2 as o,
  $5d3850c4d0b4e6c7$export$f39c2d165cd861fe as p,
  $5d3850c4d0b4e6c7$export$f99233281efd08a0 as q,
  $5d3850c4d0b4e6c7$export$393edc798c47379d as r,
  $cef8881cdc69808e$export$7c6e2c02157bb7d2 as s,
  $5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9 as t,
  $5d3850c4d0b4e6c7$export$602eac185826482c as u,
  Root$4 as v,
  Indicator$1 as w,
  Root$3 as x,
  Root$2 as y,
