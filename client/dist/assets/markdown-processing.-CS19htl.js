import { aY as fromMarkdown, aZ as toHast, a_ as trough, a$ as extend, b0 as ok$1, b1 as bail, b2 as unreachable, b3 as toJsxRuntime, j as jsxRuntimeExports, b4 as urlAttributes, b5 as visit$1, b6 as toText, b7 as fromHtmlIsomorphic, b8 as gfm, b9 as gfmFromMarkdown, ba as gfmToMarkdown, bb as math, bc as mathFromMarkdown, bd as mathToMarkdown, be as directive, bf as directiveFromMarkdown, bg as directiveToMarkdown } from "./vendor.MscUbBdQ.js";
import { lowlight } from "./markdown_highlight.BkX_n8a8.js";
import katex from "./math-katex.DxbeSjUQ.js";
...
function rehypeHighlight(options = {}) {
  ...
  return (tree, file) => {
    visit$1(tree, "element", (node, _, givenParent) => {
      const parent = (
        /** @type {Node?} */
        givenParent
      );
...
function supersub() {
  return (tree) => {
    visit$1(tree, ["text"], (node, i, parent) => {
      if (node.type !== "text") {
        return;
      }
      const { value } = node;
