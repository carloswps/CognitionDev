        ...
        mapping: {
          ...
          'system-msg': {
            ...
            message: {
              ...
              content: {
                content_type: 'text',
                parts: ['System message in middle'],
              },
              metadata: { model_slug: 'gpt-4' },
            },
          ...
          'assistant-msg-2': {
            ...
            message: {
              ...
              content: {
                content_type: 'text',
                parts: ['Second assistant response'],
              },
              metadata: { model_slug: 'gpt-4' },
            },
            parent: 'user-msg-2',
        ...
        mapping: {
          ...
          'assistant-msg-1': {
            ...
            message: {
              ...
              content: {
                content_type: 'text',
                parts: ['Assistant response with GPT-4'],
              },
              metadata: { model_slug: 'gpt-4' },
            },
            parent: 'user-msg-1',
          ...
          'user-msg-2': {
            ...
            message: {
              ...
              content: {
                content_type: 'text',
                parts: ['Another user message with GPT-4o-mini'],
              },
          ...
          'assistant-msg-2': {
            ...
            message: {
              ...
              content: {
                content_type: 'text',
                parts: ['Assistant response with GPT-3.5'],
              },
        ...
        mapping: {
          ...
          'msg-7': {
            ...
            message: {
              ...
              content: {
                content_type: 'text',
                parts: ['GPT-4-1106-preview response'],
              },
        ...
        chat_messages: [
          ...
          },
          {
            ...
            content: [
              {
                type: 'thinking',
                thinking: 'Let me calculate this simple math problem.',
              },
